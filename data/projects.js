export const projects = [
    ...
    {
        title: "Poker",
        description: "A simple lobby based Poker game to play with your friends. Emerged due to COVID and the social distancing rules. <angular, nest.js>",
    ...
    {
        title: "Owe Drahn",
        description: "A dice roller gambling game to play with your friends. <react, nest.js, Google OAuth>",
    ...
    {
        title: "Habi",
        description: "A habit tracker web app. Simply track anything. <angular, golang, auth0>",
